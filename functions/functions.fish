...
alias dbdir='cd ~/Library/"Application Support"/JetBrains/DataGrip2020.1/consoles/db/3f40dab6-6f15-4503-87d9-2c410919f763'
...
alias jl='cd && cd ~/Jupyter/ && jupyter-lab'
